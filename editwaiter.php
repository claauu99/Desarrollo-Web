...
<html lang="en">
  ...
  <body>
    ...
    <?php
      ...
      $getuser = mysql_query("SELECT * FROM garzones WHERE rut='$user'");
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          ?>
          <h2 class="sub-header">Editar garzón</h2>
          <div class="alert alert-success" role="alert" style="margin-bottom:10px; display:none;">Exito! Garzón agregado correctamente</div>
            ...
            <form id="editwaiter" name="editwaiter" role="form" method="post" data-toggle="validator" action="include/editwaiter.php">
                <div class="form-group">
                  <label for="rut">RUT</label>
                  <input type="text" name="rut" id="rut" class="form-control" readonly="readonly" placeholder="RUT" value="<?php echo $row['rut'];?>" required/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="apellido" name="apellido" class="form-control" placeholder="Apellido" value="<?php echo $row['apellido'];?>" required/>
                </div>
                <div class="form-group">
                  <label for="codigo">Código</label>
                  <input type="text" class="form-control" name="codigo"  id="codigo" placeholder="Código" value="<?php echo $row['codigo'];?>" required/>
                </div>
               <button type="submit" class="btn btn-success">Editar garzón</button>    
            </form>        
        </div>
    ...
    <script type="text/javascript">
        ...
        $('#editwaiter').validator().on('submit', function (e) {
