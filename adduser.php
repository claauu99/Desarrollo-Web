  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Añadir Usuario</h2>
          ...
          <div class="alert alert-success" role="alert" style="margin-bottom:10px; display:none;">Exito! Usuario agregado correctamente</div>
            ...
            <form id="adduser" name="adduser" role="form" data-toggle="validator" method="post" action="include/adduser.php">
    ...
    <script type="text/javascript">
      ...
      $('#adduser').validator().on('submit', function (e) {
        ...
        var posting = $.post( url, { nombre:nombre, rut:rut, apellido:apellido, codigo:codigo, password:password, tipo:tipo } );
